import type { ProjectResourceOutput } from '@/project/application/dto/resource/project-resource.dto';
import type { SearchProjectResourceUseCaseOutput } from '@/project/application/usecases/resource/search-project-resource.usecase';
