import type { ProjectCommandOutput } from '@/project/application/dto/command/project-command.dto';
import type { SearchProjectCommandUseCaseOutput } from '@/project/application/usecases/command/search-project-command.usecase';
