...
import type { TechnicalEntryOutput } from '@/technical-entry/application/dto/technical-entry/technical-entry.dto';
import type { SearchTechnicalEntryUseCaseOutput } from '@/technical-entry/application/usecases/technical-entry/search-technical-entry.usecase';
import type { TechnicalEntryType } from '@/technical-entry/domain/entities/technical-entry/technical-entry-type.enum';
